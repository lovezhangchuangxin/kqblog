    ...
    <div className="p-3 rounded-lg border border-border bg-background hover:border-primary/25 transition-colors">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 text-right">
          <div>
            <div
              className={`text-lg font-bold text-primary font-mono transition-all duration-500 ${
          ...
          <div>
            <div
              className={`text-lg font-bold text-accent font-mono transition-all duration-500 ${
                animated && mounted ? 'opacity-100' : 'opacity-0'
              }`}
            >
              {mounted ? todayVisits : '--'}
